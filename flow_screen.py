...
PERIODS = [("5営業日", 5), ("10営業日", 10), ("15営業日", 15),
...
<body>
  ...
  <h1>グローバル資金フロー</h1>
  <p class="subtitle">最終更新: {updated} | 出所: Yahoo Finance | 各テーマETF/指数の騰落率(%) | 1ヶ月リターン降順</p>
{sections}
  <p class="note">
...
COLS = ["5営業日", "10営業日", "15営業日", "1ヶ月", "3ヶ月", "年初来"]
...
def generate_html(rows):
    ...
    for group in ["資産クラス", "テーマ"]:
        ...
        grp.sort(key=lambda r: (r.get("1ヶ月") is None, -(r.get("1ヶ月") or 0)))
        body = []
        for r in grp:
