...
# HTML
# -----------------------------------------
STANCE_LABEL = {"bull": ("強気 🟢", "#4ade80"), "neutral": ("中立 🟡", "#fbbf24"),
                "bear": ("弱気 🔴", "#f87171"), "?": ("判定不能", "#64748b")}
...
{summary}
  <p class="dim" style="margin-top:6px">的中の定義: 強気=その後上昇 / 弱気=その後下落 / 中立=参考（上昇率で表示）。平均は単純平均リターン。N=検証可能な発言数（発言が新しすぎて期間未到来のものは除く）。</p>
